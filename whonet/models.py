...
class RawAntietest(models.Model):
    ...
    fdc_ne = models.TextField(null=True,blank=True,default=None)
    cza_ne = models.TextField(null=True,blank=True,default=None)
    imr_ne = models.TextField(null=True,blank=True,default=None)
    plz_ne = models.TextField(null=True,blank=True,default=None)
    czt_ne = models.TextField(null=True,blank=True,default=None)
    mev_ne = models.TextField(null=True,blank=True,default=None)
    tzd_ne = models.TextField(null=True,blank=True,default=None)
    amx_ne = models.TextField(null=True,blank=True,default=None)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class ARSPQualifyr(models.Model):
    sample_name = models.TextField(null=True,blank=True,default=None,unique=True)
    result = models.TextField(null=True,blank=True,default=None)
    date_sequence = models.TextField(null=True,blank=True,default=None)
    bactinspector_result_metric_value = models.TextField(null=True,blank=True,default=None)
    bactinspector_result_check_result = models.TextField(null=True,blank=True,default=None)
    bactinspector_species_metric_value = models.TextField(null=True,blank=True,default=None)
    bactinspector_species_check_result = models.TextField(null=True,blank=True,default=None)
